...
DROP FUNCTION IF EXISTS match_session_chunks(VECTOR, UUID[], FLOAT, INT) CASCADE;
...
-- (Optionally) drop storage bucket row
DELETE FROM storage.buckets WHERE id = 'copilot.sh';
